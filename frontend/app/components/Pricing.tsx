      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <div className="flex mx-auto border-2 border-blue-500 rounded-lg overflow-hidden mt-6 shadow-md">
            <button className="py-2 px-6 bg-linear-to-r from-blue-500 to-cyan-400 text-white font-semibold focus:outline-none">
              Monthly
            </button>
            <button className="py-2 px-6 bg-white text-gray-700 font-semibold hover:bg-gray-50 focus:outline-none transition-colors">
              Annually
            </button>
          </div>
        </div>
